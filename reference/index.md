...
- [`get_cronbach()`](https://bluefoxr.github.io/COINr/reference/get_cronbach.md)
  : Cronbach's alpha
- [`cronbach_alpha()`](https://bluefoxr.github.io/COINr/reference/cronbach_alpha.md)
...
- [`get_DEA()`](https://bluefoxr.github.io/COINr/reference/get_DEA.md) :
...
- [`get_noisy_weights2()`](https://bluefoxr.github.io/COINr/reference/get_noisy_weights2.md)
  : Noisy replications of weights
- [`get_perturbed_weight_samples()`](https://bluefoxr.github.io/COINr/reference/get_perturbed_weight_samples.md)
  : Generate samples of perturbed weights respecting requirement to sum
  to 1
...
- [`get_statistics()`](https://bluefoxr.github.io/COINr/reference/get_statistics.md)
...
- [`plot_convergence()`](https://bluefoxr.github.io/COINr/reference/plot_convergence.md)
...
- [`plot_sensitivity_pipeline()`](https://bluefoxr.github.io/COINr/reference/plot_sensitivity_pipeline.md)
  ...
  Visualise the regeneration pipeline targeted by
  [`get_sensitivity()`](https://bluefoxr.github.io/COINr/reference/get_sensitivity.md)
...
- [`get_combinations()`](https://bluefoxr.github.io/COINr/reference/get_combinations.md)
  : Test indicator combinations for composite indicators
- [`get_iCodes_in_group()`](https://bluefoxr.github.io/COINr/reference/get_iCodes_in_group.md)
...
- [`a_copeland()`](https://bluefoxr.github.io/COINr/reference/a_copeland.md)
  : Copeland scores
- [`a_dea()`](https://bluefoxr.github.io/COINr/reference/a_dea.md) :
...
- [`boxcox_auto()`](https://bluefoxr.github.io/COINr/reference/boxcox_auto.md)
...
- [`check_dset(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/check_dset.coin.md)
  : Check for named data set in coin
- [`check_dset(`*`<purse>`*`)`](https://bluefoxr.github.io/COINr/reference/check_dset.purse.md)
...
- [`Custom(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Custom.coin.md)
  [`Custom(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Custom.coin.md)
  : Custom operation
...
- [`Denominate(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Denominate.coin.md)
  [`Denominate(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Denominate.coin.md)
...
- [`get_data(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/get_data.coin.md)
  [`get_data(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/get_data.coin.md)
  : Get subsets of indicator data
...
- [`get_dset()`](https://bluefoxr.github.io/COINr/reference/get_dset.md)
  : Gets a named data set and performs checks
- [`get_pipeline_issues()`](https://bluefoxr.github.io/COINr/reference/get_pipeline_issues.md)
  : Get pipeline issues only
- [`get_stats(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/get_stats.coin.md)
  [`get_stats(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/get_stats.coin.md)
...
- [`Impute(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Impute.coin.md)
  [`Impute(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Impute.coin.md)
...
- [`Normalise(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Normalise.coin.md)
  [`Normalise(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Normalise.coin.md)
...
- [`print(`*`<purse>`*`)`](https://bluefoxr.github.io/COINr/reference/print.purse.md)
  : Print purse
- [`print(`*`<sa_pipeline>`*`)`](https://bluefoxr.github.io/COINr/reference/print.sa_pipeline.md)
  : Print method for SA pipeline tables
- [`qNormalise(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/qNormalise.coin.md)
  [`qNormalise(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/qNormalise.coin.md)
...
- [`qTreat(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/qTreat.coin.md)
  [`qTreat(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/qTreat.coin.md)
...
- [`Treat(`*`<coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Treat.coin.md)
  [`Treat(`*`<unbalanced_coin>`*`)`](https://bluefoxr.github.io/COINr/reference/Treat.coin.md)
...
- [`unbal_scen1_iData`](https://bluefoxr.github.io/COINr/reference/unbalanced_scenario_data.md)
  [`unbal_scen1_iMeta`](https://bluefoxr.github.io/COINr/reference/unbalanced_scenario_data.md)
  [`unbal_scen2_iData`](https://bluefoxr.github.io/COINr/reference/unbalanced_scenario_data.md)
  [`unbal_scen2_iMeta`](https://bluefoxr.github.io/COINr/reference/unbalanced_scenario_data.md)
  [`unbal_scen3_iData`](https://bluefoxr.github.io/COINr/reference/unbalanced_scenario_data.md)
  [`unbal_scen3_iMeta`](https://bluefoxr.github.io/COINr/reference/unbalanced_scenario_data.md)
  [`unbal_scen4_iMeta`](https://bluefoxr.github.io/COINr/reference/unbalanced_scenario_data.md)
