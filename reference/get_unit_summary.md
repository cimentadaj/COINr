...
For [unbalanced
coins](https://bluefoxr.github.io/COINr/reference/new_unbalanced_coin.md),
placeholder indicators created solely to balance the hierarchy are
removed automatically before summaries are computed, and do not appear
